                    ...
                    <ul>
                        ...
                        <li className="relative px-6 py-3">
                            ...
                            {isSideMenuOpen && (
                                <div>
                                    <ul
                                        className={`p-2 mt-2 space-y-2 overflow-hidden text-sm font-medium text-gray-500 rounded-md shadow-inner bg-gray-50 dark:text-gray-400 dark:bg-gray-900 transition-all ease-in-out duration-700 ${animationClass}`}
                                        aria-label="submenu"
                                    >
